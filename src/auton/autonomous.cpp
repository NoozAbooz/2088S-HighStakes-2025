...
void ring_rush() {
    ...
    pros::delay(530);
    intake.move_voltage(12000);
    chassis.moveToPoint(-19.634, 31.051, 2050);
    pros::delay(800);
    chassis.moveToPoint(-41.174, -2.218, 1950, {.maxSpeed= 127});
    intake.move_voltage(12000);
    pros::delay(300);
    rightDoinkerPiston.set_value(true);
    chassis.turnToHeading(115, 500, {.maxSpeed = 90});
    pros::delay(300);
    ...
    chassis.moveToPoint(-2, 3.218, 800, {.minSpeed= 127});
    ...
    chassis.moveToPoint(31, -1, 9500, {.maxSpeed = 127});
    pros::delay(500);
    // resetWallstake();
